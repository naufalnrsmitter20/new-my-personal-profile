...
export default function MyProjects() {
  const dataProject: projects[] = [
    {
      name: "Adiswisata.id",
      imageUrl: "/img/projects/adiswisata.png",
      type: "Website",
      href: "https://staging-adiswisata.vercel.app/",
    },
    {
      name: "Senara Batik",
      imageUrl: "/img/projects/senara.png",
      type: "Website",
      href: "https://senara.vercel.app/",
    },
    {
      name: "SMK Telkom Malang New",
  ...
  const filteredProjects =
    selected === "All"
      ? dataProject
      : dataProject.filter((projects) => projects.type === selected);

  return (
    <InitialAOSClient>
      <div id="project" className="h-full relative overflow-x-hidden my-10">
        <Image
          width={100}
          unoptimized
          height={100}
          className="w-screen h-full object-cover absolute top-0 left-0 z-0 rotate-180"
          src="/img/bg-topping.webp"
          alt="Background Image"
        />
        <main className="bg-primary-dark/50 backdrop-blur-md shadow-md selection:bg-slate-300 px-12 md:px-16 lg:px-24 xl:px-36 pt-14 pb-40 h-full relative">
          <h1
            data-aos="fade-left"
            data-aos-offset="100"
            data-aos-duration="500"
            className="uppercase relative text-center font-one-day text-[40px] md:text-[48px] lg:text-[56px] xl:text-[64px] font-normal tracking-widest text-white"
          >
            ...
            <div className="mt-[93px]">
              <div className="flex-wrap flex justify-center gap-2 lg:gap-x-4">
                <div
                  ...
                  data-aos="fade-right"
                >
                  <PrimaryButton onClick={() => handleCategory("All")}>
                    All
                  </PrimaryButton>
                </div>
                <div
                  ...
                  data-aos="fade-up"
                >
                  <PrimaryButton onClick={() => handleCategory("Website")}>
                    Website
                  </PrimaryButton>
                </div>
                <div
                  ...
                  data-aos="fade-left"
                >
                  <PrimaryButton onClick={() => handleCategory("Article")}>
                    Article
                  </PrimaryButton>
                </div>
                <div
                  ...
                  data-aos="fade-left"
                >
                  <PrimaryButton onClick={() => handleCategory("others")}>
                    Others
                  </PrimaryButton>
                </div>
              </div>
                    ...
                    <div>
                      <div className="flex-wrap flex justify-between py-4 px-6">
                        <Link href={projects.href} target="_blank">
                          <P className="hover:text-secondary-dark font-[500] tracking-wide group text-white">
                            {projects.name}
                          </P>
                        </Link>
                        <P className="font-[600] text-disable-slate">
                          {projects.type}
                        </P>
                      </div>
                    </div>
