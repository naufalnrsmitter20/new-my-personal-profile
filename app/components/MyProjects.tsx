  ...
  return (
    <InitialAOSClient>
      <div id="project" className="h-full relative overflow-x-hidden my-10">
        <Image width={100} unoptimized height={100} className="w-screen h-full object-cover absolute top-0 left-0 z-0 rotate-180" src="/img/bg-topping.webp" alt="Background Image" />
