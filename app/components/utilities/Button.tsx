...
const custonTheme: CustomFlowbiteTheme["button"] = {
  color: {
    ...
    fourty:
      "bg-transparent shadow-sm shadow-white text-tertiary-dark border-tertiary-dark border-2 hover:text-white hover:border-2 hover:border-white focus:bg-white focus:text-primary-dark  font-open-sans focus:ring-4 focus:border-white focus:ring-white/75 font-medium text-[10px] uppercase rounded-[6px] tracking-body transition-all duration-100",
    filtered:
      "bg-tertiary-dark/40 text-white hover:bg-secondary-dark focus:ring-secondary-dark focus:text-white focus:bg-secondary-dark font-lato focus:ring-4 font-semibold text-[16px] rounded-[6px] tracking-wide transition-all duration-100 px-3 py-1.5",
  },
};
